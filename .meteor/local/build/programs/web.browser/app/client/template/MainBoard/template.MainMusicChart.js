...
Template["MainMusicChart"] = new Template("Template.MainMusicChart", (function() {
  ...
  return HTML.DIV({
    ...
    return Spacebars.call(view.lookup("favoriteType"));
  }, function() {
    return [ "\n                        ", HTML.TH("좋아요"), "\n                    " ];
  }, function() {
    return [ "\n                        ", HTML.TH("발매일"), "\n                    " ];
    ...
    return [ "\n                    ", HTML.TR("\n                        ", HTML.TD({
      ...
      return Spacebars.call(view.lookup("chartType"));
    }, function() {
      return [ "\n                                    ", HTML.DIV({
        id: "songName"
      }, HTML.STRONG(Blaze.View("lookup:albumName", function() {
        ...
        id: "albumTitle"
      }, Blaze.View("lookup:songName", function() {
    ...
    }), "\n                            "), "\n                        "), "\n                        ", HTML.TD(Blaze.View("lookup:favoriteScore", function() {
      return Spacebars.mustache(view.lookup("favoriteScore"));
    })), "\n                    "), "\n                " ];
  }), "\n            "), "\n        "), HTML.Raw('\n        <img class="pageTopButton" src="pageup.png" style="position: absolute; bottom: 20px; right: 30px; cursor: pointer">\n    '));
}));
